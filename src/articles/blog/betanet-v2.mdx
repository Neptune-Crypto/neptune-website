...
[thumbnail]
src = "/article-images/blog/ai/rocket.jpeg"
...
Oh, and by the way, we commissioned an audit of the most error-prone parts the code base. The [report](/file-uploads/Triton_VM_Code_Final_Publishable_Audit_Hridam_Basu.pdf) found a bunch of programming-related issues but no weaknesses or vulnerabilities.
